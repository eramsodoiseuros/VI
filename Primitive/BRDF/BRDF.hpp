...
public:
    ...
    virtual // return an outgoing direction wo and brdf RGB value for a given wi and probability pair prob[2]
    RGB Sample_f (Vector wi, float *prob, Vector *wo, const BRDF_TYPES = BRDF_ALL) {return {};}
